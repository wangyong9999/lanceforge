...
async fn test_multi_table_different_schemas() {
    ...
    let batch1 = ballista_lance::executor::ipc_to_record_batch(&resp1.arrow_ipc_data).unwrap();
    ...
    let batch2 = ballista_lance::executor::ipc_to_record_batch(&resp2.arrow_ipc_data).unwrap();
